    ...
    static func uiItems() -> [BADemoItem] {
        [
            ...
            BADemoItem(title: "UI 组件",
                       ...
                       route: BADemoRoute.UI.components),
            ...
            BADemoItem(title: "瀑布流 FlowLayout",
                       ...
                       route: BADemoRoute.UI.waterfall),
    ...
    static func feedbackItems() -> [BADemoItem] {
        [
            ...
            BADemoItem(title: "自定义 Alert / 表单",
                       ...
                       route: BADemoRoute.Feedback.alert)
        ]
    }
    ...
    static func foundationItems() -> [BADemoItem] {
        [
            ...
            BADemoItem(title: "日志埋点 / Logger",
                       ...
                       route: BADemoRoute.Foundation.logger),
            BADemoItem(title: "路由 / Router",
                       ...
                       route: BADemoRoute.Foundation.routerDemo),
            BADemoItem(title: "跨模块传参 & 回调 🆕",
                       subtitle: "A 组件页面 → BARouter → D 组件页面 → 回调回传",
                       iconSystemName: "arrow.triangle.pull",
                       gradient: gradient("#3B82F6", "#06B6D4"),
                       route: BADemoRoute.Foundation.routerCaller),
            BADemoItem(title: "Network & Crypto",
                       ...
                       route: BADemoRoute.Foundation.networkCrypto),
            BADemoItem(title: "扫一扫 / Scanner",
                       ...
                       route: BADemoRoute.Foundation.scanner),
            BADemoItem(title: "基础设施 / Codable · Network",
                       ...
                       route: BADemoRoute.Foundation.infra),
