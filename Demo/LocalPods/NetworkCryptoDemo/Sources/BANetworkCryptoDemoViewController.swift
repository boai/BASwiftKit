//
//  BANetworkCryptoDemoViewController.swift
//  BASwiftKitDemo
//
...
public final class BANetworkCryptoDemoViewController: BABaseViewController {

    private let viewModel: BANetworkCryptoDemoViewModel
    private let disposeBag = BADisposeBag()
    private let tableView = UITableView(frame: .zero, style: .insetGrouped)
    private let logTextView = UITextView()

    public init(viewModel: BANetworkCryptoDemoViewModel) {
...
extension BANetworkCryptoDemoViewController: UITableViewDataSource, UITableViewDelegate {
